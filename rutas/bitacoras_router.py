        ...
        if "HRSG Pump Failures" in primer_analisis:
            ...
            try:
                ...
                if resultado_traduccion['traduccion_realizada']:
                    ...
                    print(f"ℹ️ Bitácora {bitacora_db.id} no requirió traducción")
            except Exception as e:
            ...
            # Verificar y traducir después de la clasificación
            resultado_traduccion = verificar_y_traducir_bitacora(bitacora_db.id, db)
            if resultado_traduccion['traduccion_realizada']:
                print(f"Bitácora {bitacora_db.id} traducida: {len(resultado_traduccion['campos_traducidos'])} campos")
