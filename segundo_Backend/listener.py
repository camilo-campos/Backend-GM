...
# Mapeo de canales a rutas de endpoint basado en las rutas exactas proporcionadas
CANAL_ENDPOINTS = {
    # Canales originales
    ...
    # Canales con rutas corregidas según la información más reciente
    ...
    # Canales para flujos de agua y otros
    ...
    # Corregido el formato de URL (guiones en lugar de guiones bajos)
...
CANAL_ENDPOINTS_B = {
    'canal_sensores_corriente': f"{BASE_URL_B}/prediccion_corriente",
    'canal_excentricidad_bomba': f"{BASE_URL_B}/prediccion_excentricidad_bomba",
    'canal_flujo_descarga': f"{BASE_URL_B}/prediccion_flujo_descarga",
    'canal_flujo_agua_domo_ap': f"{BASE_URL_B}/prediccion_flujo_agua_domo_ap",
    'canal_flujo_agua_domo_mp': f"{BASE_URL_B}/prediccion_flujo_agua_domo_mp",
    ...
    'canal_presion_agua': f"{BASE_URL_B}/prediccion_presion_agua",
    'canal_temperatura_ambiental': f"{BASE_URL_B}/prediccion_temperatura_ambiental",
    'canal_temperatura_agua_alim': f"{BASE_URL_B}/prediccion_temperatura_agua_alim",
    'canal_temperatura_estator': f"{BASE_URL_B}/prediccion_temperatura_estator",
    'canal_vibracion_axial_empuje': f"{BASE_URL_B}/prediccion_vibracion_axial_empuje",
    'canal_vibracion_x_descanso': f"{BASE_URL_B}/prediccion_vibracion_x_descanso",
    'canal_vibracion_y_descanso': f"{BASE_URL_B}/prediccion_vibracion_y_descanso",
    'canal_voltaje_barra': f"{BASE_URL_B}/prediccion_voltaje_barra",
}


# Nota: El canal 'canal_predicciones_bomba_a' no se incluye porque no aparece en las rutas proporcionadas

# Combinar ambos diccionarios para obtener todos los canales únicos
TODOS_LOS_ENDPOINTS = {**CANAL_ENDPOINTS, **CANAL_ENDPOINTS_B}

# Lista de canales a escuchar (todas las claves de ambos mapeos)
CANALES = list(set(CANAL_ENDPOINTS.keys()) | set(CANAL_ENDPOINTS_B.keys()))
...
def main():
    ...
    while True:
        ...
        while conn.notifies:
            ...
            try:
                # Buscar el endpoint en ambos diccionarios
                endpoint = TODOS_LOS_ENDPOINTS.get(canal)
                if not endpoint:
